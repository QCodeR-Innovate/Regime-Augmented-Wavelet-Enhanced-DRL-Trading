...
## 📄 Key Resources
* **[Read the Full Whitepaper (PDF)](./papers/Regime_Augmented_DRL_Whitepaper.pdf)** – Detailed methodology, mathematical formulation, and stress test results.
* **[View the Implementation Code](./Regime_Augmented_DRL_Implementation.ipynb)** – Complete Python notebook including data pipeline, HMM training, and PPO agent execution.
